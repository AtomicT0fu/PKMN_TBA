static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_PLAYER_HOUSE - 1] = {MAP_GROUP(PLAYER_HOUSE_B1F), MAP_NUM(PLAYER_HOUSE_B1F), 5, 4},
    [HEAL_LOCATION_VERDE_VILLAGE - 1] = {MAP_GROUP(VERDE_VILLAGE), MAP_NUM(VERDE_VILLAGE), 10, 10},
};
