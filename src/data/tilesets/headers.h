...
const struct Tileset gTileset_desert_tiles =
{
    .isCompressed = TRUE,
    .isSecondary = FALSE,
    .tiles = gTilesetTiles_desert_tiles,
    .palettes = gTilesetPalettes_desert_tiles,
    .metatiles = gMetatiles_desert_tiles,
    .metatileAttributes = gMetatileAttributes_desert_tiles,
    .callback = NULL,
};

const struct Tileset gTileset_Forest_Tiles =
{
    .isCompressed = TRUE,
    .isSecondary = FALSE,
    .tiles = gTilesetTiles_Forest_Tiles,
    .palettes = gTilesetPalettes_Forest_Tiles,
    .metatiles = gMetatiles_Forest_Tiles,
    .metatileAttributes = gMetatileAttributes_Forest_Tiles,
    .callback = NULL,
};

const struct Tileset gTileset_Grass_1 =
{
    .isCompressed = TRUE,
    .isSecondary = FALSE,
    .tiles = gTilesetTiles_Grass_1,
    .palettes = gTilesetPalettes_Grass_1,
    .metatiles = gMetatiles_Grass_1,
    .metatileAttributes = gMetatileAttributes_Grass_1,
    .callback = InitTilesetAnim_Grass_1,
};

const struct Tileset gTileset_Highland_Farms =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTiles_Highland_Farms,
    .palettes = gTilesetPalettes_Highland_Farms,
    .metatiles = gMetatiles_Highland_Farms,
    .metatileAttributes = gMetatileAttributes_Highland_Farms,
    .callback = InitTilesetAnim_Highland_Farms,
};

const struct Tileset gTileset_Bo_Ranch =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTiles_Bo_Ranch,
    .palettes = gTilesetPalettes_Bo_Ranch,
    .metatiles = gMetatiles_Bo_Ranch,
    .metatileAttributes = gMetatileAttributes_Bo_Ranch,
    .callback = NULL,
};

const struct Tileset gTileset_Indoor_Cabin =
{
    .isCompressed = TRUE,
    .isSecondary = FALSE,
    .tiles = gTilesetTiles_Indoor_Cabin,
    .palettes = gTilesetPalettes_Indoor_Cabin,
    .metatiles = gMetatiles_Indoor_Cabin,
