...
#define B_FLAG_AI_VS_AI_BATTLE      FLAG_AI_BATTLE_SET     // If this flag is set, the player's mons will be controlled by the ai next battles.
...
#define B_EXPANDED_MOVE_NAMES       TRUE  // If set to FALSE, sets name length to 12 v 16
