...
#define B_FLAG_FOLLOWERS_DISABLED      FLAG_PAUSE_FOLLOWERS          // Enables / Disables followers by using a flag. Helpful to disable followers for a period of time.
...
#define OW_FLAG_NO_ENCOUNTER        FLAG_PAUSE_ENCOUNTERS  // If this flag is set, wild encounters will be disabled.
